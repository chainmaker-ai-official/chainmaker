...
const SafetyBrake = ({ 
  ...
  const rectangleColor = type === 'blockchain' ? '#64ffda' : '#C00000';
  ...
  const blockStyle = {
    background: type === 'blockchain' ? '#0a1929' : '#2d1a1a',
    border: `1px solid ${type === 'blockchain' ? '#1e4976' : '#C00000'}`,
    color: type === 'blockchain' ? '#64ffda' : '#C00000',
  ...
  const bottomRectangleStyle = {
    ...
    borderRadius: '0',
    boxShadow: selectedPart === 'output' ? '0 0 8px #ff0000, 0 0 12px #ff0000' : 'none',
    transition: 'box-shadow 0.2s ease-in-out',
    cursor: 'crosshair'
  };
  ...
  const inputStyle = {
    ...
    minHeight: '18px',
    lineHeight: '1.2',
    caretColor: type === 'blockchain' ? '#64ffda' : '#C00000',
    boxSizing: 'border-box',
    flex: '1 1 auto'
  };
  ...
  return (
    ...
    >
      ...
      {!isPaletteItem && (
        <button
          ...
          style={{
            ...
            top: '2px',
            right: '2px',
            background: isActive ? '#C00000' : '#333',
            border: 'none',
            borderRadius: '2px',
            width: '8px',
            height: '8px',
          ...
          title={isActive ? 'Brake Active - Click to deactivate' : 'Brake Inactive - Click to activate'}
        />
      )}
      ...
      {isEditable && !isPaletteItem ? (
        ...
        <span>{(typeof label === 'string' && label.trim() !== '') ? label : 'Brake'}</span>
      )}
    </div>
  );
};
